...
XeonBotInc.ev.on("connection.update",async  (s) => {
        ...
        if (connection == "open") {
	        ...
	        console.log(chalk.magenta(`\n${themeemoji} YT CHANNEL: Fall`))
            console.log(chalk.magenta(`${themeemoji} GITHUB: Fahrul6868 `))
            console.log(chalk.magenta(`${themeemoji} INSTAGRAM: @fahrul_mt `))
